...
writing.  As of 20 August 2026 it had raised the independent-method coverage to
...
\subsection{Minimal distinct distance trees: $M(11)=60$ and $M(12)=77$}
\label{sec:mdd}
...
AI assistants, principally Anthropic Claude Code and OpenAI Codex, were used to
develop search programs, propose and test mathematical arguments, prepare
verification harnesses, organise the literature ledger and assist with drafting
and editing this note.  The author selected the research questions and
algorithmic directions, specified the verification standard, ran or authorised
the computations, and reviewed the resulting arguments, code and text.  AI
outputs were treated as untrusted: load-bearing claims were subjected to
adversarial review, differential tests, independent witness checkers and, for
the main search, a clean-room re-implementation whose authoring agent had no
access to the production source.  This process found and corrected the erroneous
earlier version of Lemma~\ref{lem:sidon}.  The author is the sole author of this
article and takes full responsibility for its content.

\section{Data and code availability}\label{sec:data}

All code and data are available at
\url{https://github.com/LSMENG/leech-trees}.  A versioned archival DOI will be
added through Zenodo when the submission release is deposited.
